...
# Vehículo NPC estilo Crossy Road.
# Se mueve en línea recta y desaparece al salir del mapa para no quedar flotando en el vacío.

signal player_hit

@export var speed: float = 5.0
@export var direction: Vector3 = Vector3.RIGHT
@export var travel_distance: float = 28.0 # Conservado por compatibilidad con la escena anterior.
...
func _face_current_direction() -> void:
	# El vehículo está construido a lo largo del eje X local.
